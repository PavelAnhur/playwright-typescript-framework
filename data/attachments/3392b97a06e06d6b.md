...
- Name: api/buyer/order-operations.spec.ts >> Buyer API -- Order Operations >> should decrement stock when order is created
- Location: tests/specs/api/buyer/order-operations.spec.ts:102:3
